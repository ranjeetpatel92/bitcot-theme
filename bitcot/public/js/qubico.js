$(document).ready(function() {
	...
	$('.project-thumb .main-link, .project-thumb .link').click(function(e) {
		...
		if (android === frame_box_value ) {
			...
			$('.imac-screen').removeClass('ios_frame');
			$('.imac-screen').removeClass('iPad_frame');
	...
	function buildPreview(elem) {
		...
		if(elem.find('.preview-content').data('images')){	
			...
			$('#project-preview .imac-frame').removeClass('hidden');
			...
			$('#project-preview .imac-frame').addClass('hidden');
		}	
	}
