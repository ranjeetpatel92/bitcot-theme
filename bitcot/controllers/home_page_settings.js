/**
 * HomePageSettings - Settings for the display of home page content in the Bitcot
 */
...
HomePageSettings.prototype.render = function(cb) {
    ...
    var pills = [
    {
        ...
        icon: 'chevron-left',
        href: '/admin/plugins/bitcot/settings'
    }];
...
HomePageSettings.getRoutes = function(cb) {
    var routes = [
        {
            method: 'get',
            path: '/admin/plugins/bitcot/settings/home_page',
            auth_required: true,
